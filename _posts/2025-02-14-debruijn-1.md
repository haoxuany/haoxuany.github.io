...
Cite: The material in this blog post and subsequent related ones are very loosely based on {% cite ExplicitSubstitutions %} and my own notes previously from taking [15-417 HOT Compilation](https://www.cs.cmu.edu/~crary/hotc/). I have contributed no original ideas besides some code.
...
- Mechanize it in LF type theory {% cite LFPaper %}.
- Nominal techniques {% cite NominalPaper %}. I admit I didn't look very deep into this methodology. One day I will get around to it.
...
Using HOAS encoding in LF Type Theory works for something simple like this, but as far as I understand it (correct me if I'm wrong), the $\Pi2$ restriction can be pretty limiting. In particular it is not very clear how you would do logical relations proofs in it. There are also a few proofs where you would need some tricks to do {% cite ExplicitContexts %}.
